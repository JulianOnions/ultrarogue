...
#define SIZE(array)	(sizeof (array) / sizeof (*(array)))
 ...
 static char pack_letters[] = "zyxwvutsrqponmlkjihgfedcba";
 static char *pack_index	= pack_letters + SIZE(pack_letters) - 1;
 static char *pack_end	= pack_letters + SIZE(pack_letters) - 1;
#endif !SORTED
