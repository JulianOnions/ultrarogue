...
struct init_armor armors[MAXARMORS] = {
	...
	{ "mithril",			99,  1, 2000, 100 },
	{ "crystalline armor",		100, 0, 3500, 300 },
};
...
struct magic_item s_magic[MAXSCROLLS] = {
    ...
    { "acquirement",		  5, 250, 50, 15 },
    { "protection",		 40, 150, 0, 0 },
    { "nothing",		 70, 50, 0, 0 },
    { "magic hitting",		 30, 275, 25, 15 },
    { "ownership",		 20, 250, 25, 15 },
    { "food detection",		 20, 150, 25, 15 },
    { "electrification",	 20, 150, 0, 0 },
};

struct magic_item p_magic[MAXPOTIONS] = {
    { "clear thought",		 90, 180, 27, 15 },
    { "gain ability",		140, 150, 15, 15 },
    { "see invisible",		 64, 170, 25, 15 },
    { "healing",		140, 130, 27, 27 },
    { "monster detection",	 60, 120, 15, 20 },
    { "magic detection",	 60, 105, 20, 15 },
    { "raise level",		  1, 280, 11, 10 },
    ...
    { "super heroism",		 10, 200, 20, 15 },
    { "disguise",		 30, 200, 0, 15 },
};

struct magic_item r_magic[MAXRINGS] = {
    { "protection",		 70, 200, 33, 25 },
    { "add strength",		 65, 200, 33, 25 },
    { "sustain ability",	 40, 180, 0, 0 },
    { "searching",		 65, 200, 0, 0 },
...
struct magic_item ws_magic[MAXSTICKS] = {
    ...
    { "disintegration",	  	 10, 150, 33, 0},
    { "anti-matter",		 30, 180, 0, 0},
    { "paralyze monster",	 40, 180, 0, 0},
